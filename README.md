...
| Feature | Description |
|---------|-------------|
| 🌑 **5 Themes** | Glacier, Midnight, Forest, Sakura, Slate |
| ✍️ **Rich Editor** | Bold, italic, tables, code blocks, image upload |
| 🖼️ **Image Support** | Drag & drop, paste, file picker |
| 🔍 **Live Search** | Instant full-text search across all pages |
| 📱 **Mobile Optimized** | Fully responsive on all screen sizes |
| 🗂️ **Nested Folders** | Collapsible sidebar navigation |
