...
const PAGE_CONTENT = {
  home: () => `
    <div class="doc-page">
      ...
      <h2>🆕 새로 추가된 기능</h2>
      <ul>
        <li><strong>📑 노트 템플릿 13종</strong> — 학생/직장인 플래너, 시간표, 칸반 보드, 가계부, 짠테크 계산기, 블로그, 결혼 준비, 전문직·자격증 시험 플래너(종류 선택)</li>
        <li><strong>🖊️ 화면 판서 모드</strong> — 강의자용! 문서 위에 바로 펜·형광펜으로 그리기</li>
        <li><strong>📑 문서 목차 이동</strong> — 목차 클릭 시 해당 위치로 부드럽게 스크롤</li>
        <li><strong>🎬 유튜브 임베드</strong> — 링크·사진·표·동영상을 노션처럼 삽입</li>
        <li><strong>🔠 글자 크기 조절</strong> — A−/A+ 버튼으로 80~150% 확대</li>
        <li><strong>✨ AI 편집 (프리미엄)</strong> — 글 붙여넣으면 블로그·보고서로 즉시 변환 + SEO/GEO 키워드 생성</li>
        <li><strong>☁️ 계정별 클라우드 저장</strong> — 구글/이메일 로그인, 기기 바꿔도 데이터 유지</li>
      </ul>
